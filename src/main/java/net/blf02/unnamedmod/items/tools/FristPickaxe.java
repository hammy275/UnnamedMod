...
public class FristPickaxe extends ToolPickaxe implements IHasModel {

	public FristPickaxe(String name, ToolMaterial material) {
		super(name, material);
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
		...
		MiningBall fireball = new MiningBall(world, player, 1, 1, 1);
